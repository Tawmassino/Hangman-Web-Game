...
let options = {
    ...
    Numbers: ["Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Eleven", "Twelve", "Thirteen", "Fourteen", "Fifteen", "Sixteen", "Seventeen", "Eighteen", "Nineteen", "Twenty", "Thirty", "Forty", "Fifty", "Sixty", "Seventy", "Eighty", "Ninety", "Hundred", "Thousand"],
    Professions: ["Administrator", "architect", "Astronaut", "builder", "chef", "cook", "dentist", "doctor", "engineer", "electrician", "factory worker", "hairdresser", "flight attendant", "firefighter", "journalist", "lawyer", "manager", "model", "musician", "nurse", "pilot", "plumber", "police officer", "receptionist", "scientist", "soldier", "teacher", "vet", "waiter", "programmer", "janitor", "driver",],
    Adjectives:["Hungry", "tired", "angry", "happy", "sad", "thirsty", "bored", "sick", "late", "patient", "punctual", "relaxed", "confused", "energetic", "smart", "stupid", "rich", "poor", "old", "young","old", "new", "empty", "full", "expensive", "cheap", "far", "near", "high", "low", "long", "short", "big", "small"],
    Adjectives2:["good", "bad", "fast", "slow", "hot", "cold", "beautiful", "fat", "slim", "dirty", "clean", "dangerous", "safe", "shy", "friendly", "wrong", "correct", "handsome", "ugly", "shy", "outgoing", "strong", "weak", "easy", "difficult", "first", "last"],
    Verbs:["Live", "sleep", "eat", "drink", "love", "write", "read", "play", "play", "sleep", "wake up", "see", "look", "watch", "walk", "run", "swim", "wait", "go", "jump", "dance", "hear", "talk", "wear", "listen", "teach", "study", "paint", "draw", "take", "give", "sell", "buy", "have", "want", "need", "help", "think", "do", "call", "phone", "meet", "work", "rest", "relax", "throw", "catch"],
};
// ========================================================================================================================================================================
...
const generateWord = (category) => {
    ...
    optionsButtons.forEach((button) => {       
        ...
        if (button.innerText.trim().toLowerCase() === category.trim().toLowerCase()) {
...
recognition.onresult = (event) => {
   ...
   if (finalTranscript) {
    ...
    // Check if the spoken word is a single letter
    if (spokenWord.length === 1 && spokenWord.match(/[A-Z]/)) {
        ...
        // Inform the user that the spoken word is not a valid guess
